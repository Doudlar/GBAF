...
<html lang="fr">
	...
	<body>
		...
		<h2>B. Source</h2>
			...
			<p>Ce document a été créé grâce à un modèle de SEQ Legal (seqlegal.com) et a été modifié par Website Planet (www.websiteplanet.com)</p>
		...
		<p>Les types d’informations personnelles suivants peuvent collectés, stockés et utilisés :</p>
			<ul>
				...
				<li>Des informations que vous saisissez quand vous créez un profil sur notre site web comme votre nom et votre prénom;</li>
				<li>Des informations que vous saisissez quand vous utilisez les services de notre site web ;</li>
				<li>Des informations que vous publiez sur notre site web dans l’intention de les publier sur internet, et qui incluent votre identifiant et le contenu de vos publications ;</li>
		...
		<h2>D. Utilisation de vos informations personnelles</h2>
		...
		<h2>E. Divulgation de vos informations personnelles</h2>
		...
		<h2>F. Transferts internationaux de données</h2>
		...
		<h2>G. Conservation de vos informations personnelles</h2>

			<p>Cette Section G détaille nos politiques de conservation des données et nos procédures, conçues pour nous aider à nous conformer à nos obligations légales concernant la conservation et la suppression d’informations personnelles.<br/>
			Les informations personnelles que nous traitons à quelque fin que ce soit ne sont pas conservées plus longtemps que nécessaire à cette fin ou à ces fins.</p>
		...
		<h2>H. Sécurité de vos informations personnelles</h2>
		...
		<h2>J. Vos droits</h2>
			...
			<p>La présentation de preuves suffisantes de votre identité (à ces fins, nous acceptons en général une photocopie de votre passeport certifiée par notaire plus une copie originale d’une facture de service public indiquant votre adresse actuelle).
		...
		<h2>L. Mise à jour des informations</h2>
		...
		<h2>M. Cookies</h2>
			...
			<p>Vous pouvez supprimer les cookies déjà stockés sur votre ordinateur. Exemple:</p>
			<ul>
				<li>avec Internet Explorer (version 10), vous devez supprimer le fichier cookies manuellement (vous pourrez trouver des instructions pour le faire ici http://support.microsoft.com/kb/278835);</li>
